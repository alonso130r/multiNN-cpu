...
private:
    std::vector<Neuron> neurons;
    static std::vector<double> calculateMeans(const std::vector<std::vector<double>> &inputs);
...
public:
    using Layer::Layer;
    static std::vector<std::vector<double>> normalize(const std::vector<std::vector<double>> &inputs);
};
